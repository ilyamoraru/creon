    ...
    private function constants() {
      ...
      if ( false == OT_THEME_MODE && false == OT_CHILD_THEME_MODE ) {
        ...
        if ( true == OT_CHILD_THEME_MODE ) {
            ...
            $path = ltrim( end( $components ), '/' );          define( 'OT_DIR', trailingslashit( trailingslashit( get_stylesheet_directory() ) . $path ) );
          define( 'OT_URL', trailingslashit( trailingslashit( get_stylesheet_directory_uri() ) . $path ) );
            ...
            $path = ltrim( end( $components ), '/' );          define( 'OT_DIR', trailingslashit( trailingslashit( get_template_directory() ) . $path ) );
